...
from utils import calc_metrics, prepare_mnist, weight_schedule,prepare_kmnist,prepare_fashion_mnist,prepare_emnist,prepare_cifar10,prepare_cifar100
...
for i in range(cfg['n_exp']):
    ...
    seed = cfg['seeds'][i]
    acc, acc_best, l, sl, usl, indices = train(model, seed,prepare_cifar100, **cfg)
    accs.append(acc)
